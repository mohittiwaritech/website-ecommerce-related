...
const Shipping = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 font-sans">
      <SEO title="POS Hardware Shipping in India" description="Delivery time for POS machines, thermal printers and scanners from Noida to metro and non-metro India. Software delivered by email." keywords={['POS shipping India', 'thermal printer delivery Noida']} />

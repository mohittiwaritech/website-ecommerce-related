...
const Privacy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 font-sans">
      <SEO title="Privacy Policy" description="How BillingZone uses data when you buy POS machines, printers or billing software on billingzone.in." keywords={['POS privacy', 'billing software privacy']} />

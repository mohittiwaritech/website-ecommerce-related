        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="text-[13px] space-y-3">
              <li><Link href="/products?category=Billing%20Software" className="hover:text-blue-400 hover:translate-x-1 transition-all inline-block">SOFTWARE</Link></li>
              <li><Link href="/products?type=hardware" className="hover:text-blue-400 hover:translate-x-1 transition-all inline-block">HARDWARE</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="text-[13px] space-y-3">
              <li><Link href="/drivers" className="hover:text-blue-400 hover:translate-x-1 transition-all inline-block">Printer Drivers & Manuals</Link></li>
              <li><Link href="/terms" className="hover:text-blue-400 hover:translate-x-1 transition-all inline-block">Terms & Conditions</Link></li>
              ...
              <li><Link href="/refund" className="hover:text-blue-400 hover:translate-x-1 transition-all inline-block">Refund Policy</Link></li>
              <li><Link href="/shipping" className="hover:text-blue-400 hover:translate-x-1 transition-all inline-block">Shipping Policy</Link></li>
            </ul>
          </div>

                  ...
                  >
                    ...
                    <td className="py-4">
                      <div className="flex items-center gap-4">
                        ...
                        {/* TITLE */}
                        <div>
                          <Link href={getProductUrl(item)} className="text-blue-600 hover:text-blue-800 text-sm leading-6 max-w-[250px] font-medium transition-colors hover:underline block">
                            {item.title}
                          </Link>
                        </div>
                      </div>
